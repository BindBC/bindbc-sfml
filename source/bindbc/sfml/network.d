...
static if(staticSFML) {
    extern(C) @nogc nothrow {
        ...
        } else sfFtpResponse* sfFtp_upload(sfFtp* ftp, const(char)* localFile, const(char)* destPath, sfFtpTransferMode mode);
        ...
        else sfSocketStatus sfUdpSocket_bind(sfUdpSocket* socket, ushort port);
    ...
    extern(C) @nogc nothrow {
        ...
        else alias psfFtp_upload = sfFtpResponse* function(sfFtp* ftp, const(char)* localFile, const(char)* destPath, sfFtpTransferMode mode);
        ...
        else alias psfTcpListener_listen = sfSocketStatus function(sfTcpListener* listener, ushort port);
        ...
        else alias psfUdpSocket_bind = sfSocketStatus function(sfUdpSocket* socket, ushort port);
